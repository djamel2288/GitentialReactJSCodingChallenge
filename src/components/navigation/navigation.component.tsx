...
export interface NavigationComponentProps extends NavigationComponentPropsFromRedux {
}
...
export type NavigationComponentPropsFromRedux = ConnectedProps<typeof connector>
