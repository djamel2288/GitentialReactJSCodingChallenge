...
import { isAuthTokenValid, setAuthTokenToLocalStorage } from './auth-token-input.utils'
...
export interface AuthTokenInputComponentProps extends AuthTokenInputComponentPropsFromRedux {
}
...
export type AuthTokenInputComponentPropsFromRedux = ConnectedProps<typeof connector>
